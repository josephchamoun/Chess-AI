...
from minmax import find_best_move2
...
SQUARE_SIZE = WIDTH // 8
INFO_PANEL_HEIGHT = HEIGHT - WIDTH 

BOARD_LIGHT = (230, 205, 170)
BOARD_DARK = (170, 125, 90)   
BOARD_BORDER_COLOR = (50, 50, 50) 


HIGHLIGHT_SELECTED = (255, 215, 0, 150) 
HIGHLIGHT_LEGAL_MOVE_DOT = (0, 0, 0, 50) 
HIGHLIGHT_LEGAL_MOVE_RING = (100, 150, 255, 100) 
HIGHLIGHT_CAPTURE = (200, 50, 50, 150) 
...
def main():
    ...
    while running:
        ...
        if game.board.turn != PLAYER_COLOR:
            ...
            best_move = find_best_move2(game.board, AI_DEPTH)
            if best_move:
                print(f"AI makes move: {best_move.uci()}") 
